...
public class MtvSqLiteOpenHelper extends SQLiteOpenHelper {
	...
	public static final String COLUMN_CONTACT_ADRESS_FK_PERSON = "personid";
	...
	private List<TableDefinition> getTables() {
		...
		columns.add(new ColumnDefinition(DataType.INTEGER, COLUMN_CONTACT_ADRESS_FK_PERSON, "not null"));
	...
	private static final String CREATE_ADRESS = "create table " + TABLE_ADRESS + "(" +
			COLUMN_ID + " integer primary key autoincrement, " +
			COLUMN_CONTACT_ADRESS_FK_PERSON + " integer not null, " +
			COLUMN_ADRESS_STREET + " text not null, " +
			COLUMN_ADRESS_ZIP + " text not null, " +
			COLUMN_ADRESS_CITY + " text not null, " +
			"FOREIGN KEY(" + COLUMN_CONTACT_ADRESS_FK_PERSON + ") REFERENCES " + TABLE_PERSON + "(" + COLUMN_ID + "))";
